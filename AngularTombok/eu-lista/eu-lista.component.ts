...
@Component({
  selector: 'app-eu-lista',
  templateUrl: './eu-lista.component.html',
  styleUrls: ['./eu-lista.component.css']
})
export class EuListaComponent {
  EuropaiUnio: euLista[] = [{
    orszag: "Ausztria",
  ...
  ngOnInit() {
    this.EuropaiUnio.sort((a, b) => a.csatlakozas.localeCompare(b.csatlakozas));
  }

}
export interface euLista {
  orszag: string;
  csatlakozas: string;
}